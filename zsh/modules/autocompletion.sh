...
# oh-my-zsh lib (e.g. directories.zsh) calls compdef during antidote load,
# before stack's compinit. Stub until compinit replaces it.
compdef() { : }
...
# (all must be in fpath before compinit runs in .zshrc via stack init)
